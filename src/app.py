...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice soccer skills and play friendly matches with other schools",
    ...
    "Science Olympiad": {
        ...
        "max_participants": 20,
        "participants": ["nina@mergington.edu", "kevin@mergington.edu", "ava@mergington.edu"]
    }
}
